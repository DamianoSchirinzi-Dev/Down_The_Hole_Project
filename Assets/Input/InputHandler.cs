...
public class InputHandler : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        if (!playerController.isPaused || !playerController.isDead)
        {
            ...
            {
                playerAnimationManager.setIsMoving(true);
            }
            else
            {
                playerAnimationManager.setIsMoving(false);
            }

            playerAnimationManager.setIsGround(playerController.isGrounded);
        }
    }
    ...
    private void OnSprint(InputAction.CallbackContext context)
    {
        ...
        playerAnimationManager.setIsSprinting(true);
    }
    private void StopSprint(InputAction.CallbackContext context)
    {
        playerController.isSprinting = false;
        playerAnimationManager.setIsSprinting(false);
    }
    ...
    private void OnJump(InputAction.CallbackContext context)
    {
        if (playerController.isGrounded)
        {
            ...
            playerAnimationManager.startJump();
        }
    }
